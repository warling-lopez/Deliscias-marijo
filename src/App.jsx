...
const TwitterIcon = () => (
  <svg
    ...
    strokeLinejoin="round"
  >
    <path d="M22 4s-.7 2.1-2 3.4c1.6 1.4 3.3 4.9 3 7.1 0 .8-.4 1.5-.9 2.2-1.1 1.4-2.6 2.3-4.2 2.7-1 .2-2.1.3-3.2.3h-1c-3.1 0-5.7-1.3-7.4-3.4-2.4-2.9-3.1-6.6-2.4-9.6C3.9 6.3 5.7 5 7.7 4.4c1.1-.3 2.3-.3 3.4 0 .8.2 1.5.6 2.1 1-.2-.9-.1-1.8.2-2.6.4-1 .9-1.8 1.6-2.5 1-.9 2.2-1.5 3.5-1.7.9-.1 1.8 0 2.6.3s1.5.8 2 1.4c.1-2 .9-3.6 2.4-4.5" />
  </svg>
);
...
export default function App() {
  ...
  return (
    <div className="bg-pink-200 font-sans text-zinc-700 min-h-screen">
      ...
      <main>
        {/* --- Sección Héroe --- */}
        <section className="text-center h-130  py-20 px-6 bg-rose-50/50 md:bg-[url(/fondo.jpg)] md:bg-no-repeat md:bg-cover">
          <div className="container mx-auto">
            ...
            <p className="mt-4 max-w-2xl mx-auto text-zinc-600">
              Elaboramos artesanalmente los pasteles y postres más exquisitos
              con ingredientes de la más alta calidad, bajos en azúcar y llenos
              de sabor.
            </p>
        ...
        <section className="py-24 bg-blue-100 px-6">
          <div className="container mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="mt-2 text-zinc-500 max-w-xl mx-auto">
                Desde celebraciones íntimas hasta grandes eventos, creamos el
                pastel perfecto para tu ocasión especial.
              </p>
            </div>
            <div className="md:grid grid-cols-1 flex-wrap flex justify-center lg:grid-cols-4 gap-8">
              {customCakes.map((producto, index) => (
                <ProductCard key={index} name={producto.nombre} caracteristicas={producto.caracteristicas} precio={producto.precio} url={producto.url}/>
              ))}
            </div>
          </div>
        </section>
            ...
            <div className="flex flex-col md:flex-row items-center gap-12">
              ...
              <div className="w-full md:w-1/2 flex justify-center">
                <div className="bg-white p-10 rounded-lg shadow-xl text-center border-t-4 border-pink-300 max-w-md">
                  <h4 className="text-3xl font-serif text-pink-500">
                    Colección de Temporada
                  </h4>
                  <p className="text-6xl font-bold text-zinc-800 my-4">
                    20% OFF
                  </p>
                  <p className="text-zinc-500 mb-6">
                    Disfruta de un dulce descuento en nuestros postres y
                    macarons seleccionados.
                  </p>
